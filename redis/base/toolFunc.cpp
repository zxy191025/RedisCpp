 ...
 */
void toolFunc::init_genrand64(unsigned long long seed)
{
    mt[0] = seed;
 ...
 */
void toolFunc::init_by_array64(unsigned long long init_key[],unsigned long long key_length)
{
 ...
 */
unsigned long long toolFunc::genrand64_int64(void)
{
    int i;
 ...
 */
long long toolFunc::genrand64_int63(void)
{
 ...
 * @note 精度约为2^-53
 */
double toolFunc::genrand64_real1(void)
{
 ...
 */
double toolFunc::genrand64_real2(void)
{
 ...
 * @note 适用于需要非零值的概率场景
 */
double toolFunc::genrand64_real3(void)
{
    return ((genrand64_int64() >> 12) + 0.5) * (1.0/4503599627370496.0);
}

unsigned int toolFunc::lzf_compress (const void *const in_data,  unsigned int in_len, void *out_data, unsigned int out_len)
{
    #if !LZF_STATE_ARG
    LZF_STATE htab;
    #endif
...
unsigned int toolFunc::lzf_decompress (const void *const in_data,  unsigned int in_len,void *out_data, unsigned int out_len)
{
